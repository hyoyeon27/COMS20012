...
9.	**Test Connectivity between PC and router:** use `ping 192.168.1.1`from first PC to verify network connection.
...
23.	Click on the second router and select the config tab. 
